import{P as PaperRippleBehavior,b as assert,z as I18nMixin,k as hexColorToSkColor,c as skColorToRgba,N as NewTabPageProxy,F as FocusOutlineManager,a as assertNotReached,E as EventTracker,x as createScrollBorders,l as CustomizeDialogPage,B as BrowserCommandProxy,n as CrAutoImgElement,W as WindowProxy,C as Command,D as assertInstanceof,h as hasKeyModifiers,G as isRTL,H as isIOS,J as getDeepActiveElement,i as isWindows,K as isMac,j as recordLoadDuration,r as recordDuration,o as recordOccurence,L as listenOnce,g as getFaviconForPageURL,S as SUPPORTED_FILE_TYPES,p as processFile,q as recordPerdecage}from"./shared.rollup.js";export{V as VoiceSearchOverlayElement}from"./shared.rollup.js";import{html,mixinBehaviors,PolymerElement,Polymer,dom,dedupingMixin,FlattenedNodesObserver,templatize,afterNextRender,microTask}from"chrome://resources/polymer/v3_0/polymer/polymer_bundled.min.js";import{CustomizeThemesHandlerRemote,CustomizeThemesClientCallbackRouter,CustomizeThemesHandlerFactory,ThemeType}from"chrome://resources/cr_components/customize_themes/customize_themes.mojom-webui.js";import"./strings.m.js";import{loadTimeData}from"chrome://resources/js/load_time_data.js";import{CustomizeDialogAction,OptInStatus as OptInStatus$1}from"./new_tab_page.mojom-webui.js";import{CartHandler,ConsentStatus}from"./chrome_cart.mojom-webui.js";import{DriveHandler}from"./drive.mojom-webui.js";import{FeedHandler}from"./feed.mojom-webui.js";import{PageHandler}from"./history_clusters.mojom-webui.js";import"./discount.mojom-webui.js";import{LayoutType}from"./history_clusters_layout_type.mojom-webui.js";import{PhotosHandler}from"./photos.mojom-webui.js";import{RecipesHandler}from"./recipes.mojom-webui.js";import{InteractionState,Annotation}from"./history_cluster_types.mojom-webui.js";import{PageHandler as PageHandler$1}from"./history_clusters_v2.mojom-webui.js";import{TextDirection}from"chrome://resources/mojo/mojo/public/mojom/base/text_direction.mojom-webui.js";import{MostVisitedPageCallbackRouter,MostVisitedPageHandlerRemote,MostVisitedPageHandlerFactory}from"chrome://resources/cr_components/most_visited/most_visited.mojom-webui.js";import{PageImageServiceHandler,ClientId}from"chrome://resources/cr_components/page_image_service/page_image_service.mojom-webui.js";import"chrome://resources/mojo/mojo/public/js/bindings.js";function getTemplate$H(){return html`<!--_html_template_start_-->    <style>:host{--cr-toggle-checked-bar-color:var(--google-blue-600);--cr-toggle-checked-button-color:var(--google-blue-600);--cr-toggle-checked-ripple-color:rgba(var(--google-blue-600-rgb), .2);--cr-toggle-ripple-diameter:40px;--cr-toggle-unchecked-bar-color:var(--google-grey-400);--cr-toggle-unchecked-button-color:white;--cr-toggle-unchecked-ripple-color:rgba(var(--google-grey-600-rgb), .15);-webkit-tap-highlight-color:transparent;cursor:pointer;display:block;min-width:34px;outline:0;position:relative;width:34px}:host-context([chrome-refresh-2023]):host{--cr-toggle-checked-bar-color:var(--color-toggle-button-track-on,
...
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.
const ManagedDialogElementBase=I18nMixin(PolymerElement);class ManagedDialogElement extends ManagedDialogElementBase{static get is(){return"managed-dialog"}static get template(){return getTemplate$G()}static get properties(){return{title:String,body:String}}onOkClick_(){this.$.dialog.close()}}customElements.define(ManagedDialogElement.is,ManagedDialogElement);function getTemplate$F(){return html`<!--_html_template_start_--><style>:host{--cr-grid-gap:0px;--cr-column-width:auto;--cr-grid-width:fit-content}#grid{display:grid;grid-gap:var(--cr-grid-gap);grid-template-columns:repeat(var(--cr-grid-columns),var(--cr-column-width));width:var(--cr-grid-width)}::slotted(*){align-self:center;justify-self:center}</style>
...
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.
class ThemeIconElement extends PolymerElement{static get is(){return"cr-theme-icon"}static get template(){return getTemplate$E()}}customElements.define(ThemeIconElement.is,ThemeIconElement);
/**
@license
...
<cr-grid id="collections" columns="3" hidden="[[!showBackgroundSelection_]]">
  <div id="uploadFromDevice" class="tile" role="button" on-click="onUploadFromDeviceClick_" tabindex="0">
    <div class$="[[getCustomBackgroundClass_(theme, backgroundSelection)]]">
      ...
      <div id="uploadFromDeviceImage">
        ...
        <div class="label">Subir desde el dispositivo</div>
      </div>
  ...
  <div id="noBackground" class="tile" role="button" on-click="onDefaultClick_" tabindex="0">
    ...
    <div class="label">Chrome predeterminado</div>
  </div>
...
<div id="options">
  <div id="optionCustomLinks" class$="option [[getCustomLinksSelected_(customLinksEnabled_, hide_)]]">
    <cr-button id="optionCustomLinksButton" class="option-image" tabindex="0" aria-pressed$="[[getCustomLinksAriaPressed_(customLinksEnabled_,
            hide_)]]" title="Mis accesos directos" on-click="onCustomLinksClick_" noink>
    ...
    <div class="option-title">Mis accesos directos</div>
    <div class="option-description">Tú seleccionas los accesos directos</div>
  </div>
  <div id="optionMostVisited" class$="option [[getMostVisitedSelected_(customLinksEnabled_, hide_)]]">
    <cr-button id="optionMostVisitedButton" class="option-image" tabindex="0" aria-pressed$="[[getMostVisitedAriaPressed_(customLinksEnabled_,
            hide_)]]" title="Sitios más visitados" on-click="onMostVisitedClick_" on-keydown="onMostVistedKey" noink>
      <div class="option-icon"></div>
      <div class="option-mini">
        <ntp-mini-page single-colored-logo></ntp-mini-page>
      </div>
...
`.content);styleMod$1.register("cr-radio-button-style");function getTemplate$z(){return html`<!--_html_template_start_-->    <style include="cr-radio-button-style cr-hidden-style"></style>
...
<div id="container" hidden>
  <div id="show">
    <cr-radio-group selected="[[radioSelection_(show_)]]" disabled="[[showManagedByPolicy_]]" on-selected-changed="onShowRadioSelectionChanged_">
      <cr-radio-button id="hideButton" name="hide" label="Ocultar todas las tarjetas">
      </cr-radio-button>
      <cr-radio-button id="customizeButton" name="customize" label="Personalizar tarjetas">
      </cr-radio-button>
    </cr-radio-group>
      ...
      <div class="toggle-section">
        ...
        <template is="dom-if" if="[[showCartOptionToggle_(item.id, item.checked)]]">
          <div id="cartOption" class="toggle-option-row">
            ...
            <cr-toggle checked="{{cartOptionToggle_.enabled}}" title="Tus carritos"></cr-toggle>
          </div>
        </template>
        <template is="dom-if" if="[[showDiscountOptionToggle_(item.id, item.checked,
          ...
          <div id="discountOption" class="toggle-option-row">
            ...
            <cr-toggle checked="{{discountOptionToggle_.enabled}}" title="Obtener descuentos"></cr-toggle>
          </div>
        </template>
      </div>
    </template>
  ...
  <div slot="title">
    ...
    <div id="title">
      ...
      <div id="titleNavigation" hidden="[[!showTitleNavigation_]]">
        <cr-icon-button id="backButton" class="icon-arrow-back" on-click="onBackClick_" title="Atrás">
        </cr-icon-button>
...
<div id="titleContainer">
  ...
  <template is="dom-if" if="[[showInfoButton]]">
    <cr-icon-button id="infoButton" title="Acerca de esta tarjeta" on-click="onInfoButtonClick_">
    </cr-icon-button>
  </template>
...
<div id="consentCardContainer">
  ...
  <template is="dom-if" if="[[showCloseButton_]]" restamp>
    <cr-icon-button id="close" class="icon-clear" aria-label="Cerrar" on-click="onCloseClick_"></cr-icon-button>
  </template>
</div>
          ...
          <template is="dom-if" if="[[!discountConsentHasTwoSteps_]]" restamp>
            <div id="consentCard">
              ...
              <span id="consentContent">
                ¿Quieres que Google busque descuentos personalizados en tus carritos?
              </span>
      ...
      <div id="optInContent">
        <div>
          ...
          <span id="optInTitleDesc">
            Accede a tu cuenta y explora tus recuerdos de Google Fotos.
          </span>
        </div>
        <div>
  ...
  <template id="memoriesElement" is="dom-if" if="[[!showOptInScreen]]">
    ...
    <template id="exploreCardElement" is="dom-if" if="[[showExploreMore_]]">
      <a href="https://photos.google.com?referrer=CHROME_NTP" class="card" on-click="onMemoryClick_" target="_blank" id="exploreCard">
        ...
        <div id="exploreText">
          Explora más recuerdos en Google Fotos
        </div>
      </a>
    </template>
  </template>
...
<div id="dialog" hidden$="{{isHidden_}}" tabindex="-1" lang="es" role="dialog" aria-modal="true" on-focusout="onFocusOut_">
  <ntp-lens-form id="lensForm" on-loading="handleFormLoading_" on-error="handleFormError_">
  </ntp-lens-form>
  <div id="container">
    <cr-icon-button id="closeButton" class="icon-clear" title="Cerrar" on-click="onCloseButtonClick_" on-keydown="onCloseButtonKeydown_">
    </cr-icon-button>
    <div id="title">
      Busca cualquier imagen con Google Lens
    </div>
    <div id="dragDropArea" on-dragenter="onDragEnter_" on-dragover="onDragOver_" on-dragleave="onDragLeave_" on-drop="onDrop_">
      ...
      <template is="dom-if" if="{{isNormalOrError_}}">
        <div class="drag-drop-title-container">
          ...
          <div class="drag-drop-title">
            <span id="dragText">Arrastra una imagen hasta aquí o</span>
        ...
        <div id="urlUploadContainer">
          <div id="sectionDivider">
            ...
            <div id="orLabel">O</div>
            <div class="divider-line"></div>
          </div>
          <div id="inputContainer">
            <input id="inputBox" autocomplete="false" autocorrect="false" placeholder="Pegar vínculo de imagen" text="text" value="{{uploadUrl_::input}}" on-keydown="onUrlKeyDown_">
      ...
      <template is="dom-if" if="{{isDragging_}}">
        <div class="drag-drop-title-container">
          <div class="drag-drop-title">
            Arrastra una imagen hasta aquí
          </div>
        </div>
      </template>
...
<cr-dialog id="dialog" show-close-button on-cancel="onDismissClick_" show-on-attach close-text="Cerrar">
  <div slot="title">Tus carritos</div>
  <div slot="body">
    <div id="content-container" tabindex="0">
      <div id="content-title">¿Quieres obtener descuentos?</div>
      <div id="content">¿Quieres que Google use tu carrito para buscar descuentos disponibles?</div>
    </div>
...
<cr-dialog id="dialog" consume-keydown-event>
  <div slot="title">Acerca de esta tarjeta</div>
  <div slot="body">
    <slot></slot>
  </div>
  <div slot="button-container">
...
<div id="freAndModulesContainer">
  <template is="dom-if" if="[[modulesFreShown]]">
    <div id="firstRunExperience">
      ...
      <div id="newTag">Nuevo</div>
      <div class="first-run-experience-body">
        Elige las tarjetas que te mantienen al tanto de lo que te importa.
      </div>
      <div class="first-run-experience-body">
        Consulta todas las opciones de tarjetas en <a is="action-link" id="customizeChromeLink" tabIndex=0 on-click="onCustomizeModuleFre_">Personalizar Chrome</a>
      </div>
...
<cr-toast id="removeModuleToast" duration="10000">
  ...
  <template is="dom-if" if="[[removedModuleData_.undo]]">
    <cr-button id="undoRemoveModuleButton" aria-label="Presiona Ctrl+Z para deshacer" on-click="onUndoRemoveModuleButtonClick_">
      Deshacer
    </cr-button>
  </template>
</cr-toast>
<cr-toast id="removeModuleFreToast" duration="10000">
  <div id="removeModuleFreToastMessage">
    No volverás a ver tarjetas en esta página
  </div>
  <cr-button id="undoRemoveModuleFreButton" aria-label="Presiona Ctrl+Z para deshacer" on-click="onUndoRemoveModuleFreButtonClick_">
    Deshacer
  </cr-button>
</cr-toast>
<!--_html_template_end_-->`}
...
<cr-toast id="undoToast" duration="10000">
  ...
  <template is="dom-if" if="[[undoData_.undo]]">
    <cr-button id="undoButton" aria-label="Presiona Ctrl+Z para deshacer" on-click="onUndoButtonClick_">
      Deshacer
    </cr-button>
  </template>
</cr-toast>
